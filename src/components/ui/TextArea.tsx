    ...
    return (
      <div>
        ...
        <textarea
          ...
          id={textareaId}
          className={cn(
            'w-full rounded-lg border border-gray-300 px-3 py-2 text-sm outline-none transition-colors min-h-[100px] dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100',
